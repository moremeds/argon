...
| Option surface capture (durable IV/greeks grid) | `src/uw_scan/worker/jobs/option_surface_capture.py` + `option_surface_iv_canary.py` + `storage/option_surface_grid.py` + `storage/option_surface_iv_canary.py` (grid migration 077/078, jobs at 19:00/19:30 weekdays uw-0) |
