...
def test_gold_warmup_uses_full_history_etf_holdings_lookback(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        gold_warmup, "gold_comex_vault_ingest_job", lambda **_kwargs: None
    )
    monkeypatch.setattr(gold_warmup, "gold_cftc_cot_ingest_job", lambda **_kwargs: None)
    monkeypatch.setattr(
        gold_warmup, "gold_lbma_vault_ingest_job", lambda **_kwargs: None
    )
    monkeypatch.setattr(gold_warmup, "gold_wgc_cb_ingest_job", lambda **_kwargs: None)
    monkeypatch.setattr(
        gold_warmup, "gold_uw_options_ingest_job", lambda **_kwargs: None
    )
    ...
    monkeypatch.setattr(
        gold_warmup, "gold_etf_holdings_ingest_job", _capture_etf_holdings
    )
