...
- Required production hardening after these v1 slices: real Postgres integration test execution, live UW API smoke tests, and repeated browser-rendered TradingView reliability checks against real shared watchlist URLs.
