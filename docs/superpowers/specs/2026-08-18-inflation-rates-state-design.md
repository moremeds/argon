...
| D2 | migration `116_macro_domain_states.sql` | 116 is MC1's `macro_source_status`; 122 is `revenue_breakdown_obs`, merged 2026-08-18 | MC2's migration is **`123_macro_domain_states.sql`** |
