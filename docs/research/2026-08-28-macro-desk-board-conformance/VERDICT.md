...
**Shipped:** `feat/macro-desk-tab-00` (tab 00) and `feat/macro-desk-tabs-03-05` (tabs 01–05), neither merged
**Question:** which of the board's designed panels actually reached the desk

## Why this exists

The port plan (`docs/superpowers/plans/2026-08-27-macro-desk-page-port.md`) §1 declares a
