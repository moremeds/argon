...
> **INVALID (2026-09-24).** The RV−IV benchmark factor read `vrp_daily.rv`, which was UW's FORWARD RV (returns t..t+20) and overlaps the h=1/5 target horizon. This verdict needs a re-run on the rebuilt `vrp_daily`; see `docs/research/2026-09-24-uw-rv-forward-lookahead/README.md`.
