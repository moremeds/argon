...
/**
 * Macro short-vol ACTION readout for SPX — a sibling of the GEX Directional Bias
 * card (same `.gex-bias-*` styling), placed in the bottom 3-col row alongside
 * Expected Range + Directional Bias. The action (TRADE/SKIP) is the headline;
 * vrp_z / sizing reasons sit underneath. The tracked entry + sizing guidance
 * render in <MacroShortVolEntryGuidance> on the row below.
 */
