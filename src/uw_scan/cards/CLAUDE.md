...
- **Structure / flow analytics** — `skew_first_principles.py`, `structural_flow.py`, `exposures.py`, `option_chain.py`, `greek_exposure_history.py`, `intraday_profile.py`, `framework_tape.py`, `matrix_state.py`, `magnets.py` (Magnet View deriver), `technicals.py` (dual MACD + live technicals, largest module)
